...
public class ExceptionFilterTests
{
    ...
    public void OnException_UnauthorizedAccessException_Returns401()
    {
        ...
        Assert.AreEqual("No autorizado", result.Value?.GetType().GetProperty("error")?.GetValue(result.Value));
    }
    ...
    public void OnException_ArgumentException_Returns400()
    {
        ...
        Assert.AreEqual("Argumento inválido", result.Value?.GetType().GetProperty("error")?.GetValue(result.Value));
    }
    ...
    public void OnException_InvalidOperationException_Returns400()
    {
        ...
        Assert.IsNotNull(result);
        Assert.AreEqual((int)HttpStatusCode.BadRequest, result.StatusCode);
        Assert.AreEqual("Operación inválida", result.Value?.GetType().GetProperty("error")?.GetValue(result.Value));
    }
    ...
    public void OnException_KeyNotFoundException_Returns404()
    {
        ...
        Assert.AreEqual("No encontrado", result.Value?.GetType().GetProperty("error")?.GetValue(result.Value));
    }
    ...
    public void OnException_UnknownException_Returns500()
    {
        ...
        Assert.AreEqual("Ocurrió un error inesperado.",
