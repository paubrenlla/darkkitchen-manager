...
1. **New Database Connection** → seleccioná **SQL Server**![alt text](images/image.png)
...
2. Click derecho sobre el schema → **SQL Editor** → **Open SQL script**![alt text](images/image-2.png)
